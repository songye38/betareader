...
const GenreInput = ({ control, error }) => {
  ...
  return (
    <div style={{ width: 621, height: 'auto', paddingLeft: 28, paddingRight: 28, paddingTop: 20, paddingBottom: 20, background: '#1E1F24', borderRadius: 20, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 16, display: 'inline-flex' }}>
      <div style={{ display: 'flex', flexDirection: 'row' }}>
        <div style={{ color: 'white', fontSize: 20, fontFamily: 'Pretendard', fontWeight: '600', lineHeight: '33.60px', wordWrap: 'break-word' }}>장르</div>
